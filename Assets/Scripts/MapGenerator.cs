...
public class MapGenerator : MonoBehaviour {
	...
	public const int mapChunkSize = 241; // Constant height and width
	[Range(0,6)]
	public int editorPreviewLOD;
	public float noiseScale;

	public int octaves;
	[Range(0,1)] // Limit the persistance range between 0 and 1
	...
	// Customizable amount of Terrains
	public TerrainType[] regions;

	Queue<MapThreadInfo<MapData>> mapDataThreadInfoQueue = new Queue<MapThreadInfo<MapData>>();
	Queue<MapThreadInfo<MeshData>> meshDataThreadInfoQueue = new Queue<MapThreadInfo<MeshData>>();

	// Generate the map depending ont he draw mode
	public void DrawMapInEditor() {
		MapData mapData = GenerateMapData (Vector2.zero);

		// Generate Map on Object Depending on the Mode
		...
		if (drawMode == DrawMode.NoiseMap) {
			...
			// TODO: OR Generate Trees Randomly here
		}
	}
	...
	// Generate a ColorMap based on the NoiseMap
	...
	// Clamp variables to specific values
	void OnValidate() {
		if (lacunarity < 1) {
			lacunarity = 1;
		}
